...
from finance.models import InvoiceModel, SalaryStructure, SalarySetting, ExpenseModel, DiscountModel, DiscountApplicationModel, StudentDiscountModel, InvoiceItemModel,SalaryRecord, StaffFundingModel, StudentFundingModel, FeePaymentModel
